...
INSERT INTO sec_role (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, name, loc_name, description, is_default_role, role_type, SECURITY_SCOPE) VALUES ('ecf07a97-7e35-caf1-f6b4-6667cc1ebcde', now(), 'admin', 1, now(), NULL, NULL, NULL, 'Mathematicians', NULL, NULL, NULL, NULL, 'GENERIC_UI');
INSERT INTO sec_role (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, name, loc_name, description, is_default_role, role_type, SECURITY_SCOPE) VALUES ('b483c4d0-bb9a-1fc3-cbe3-d313661e0a40', now(), 'admin', 1, now(), NULL, NULL, NULL, 'Gauss', NULL, NULL, NULL, NULL, 'GENERIC_UI');
INSERT INTO sec_role (id, create_ts, created_by, version, update_ts, updated_by, delete_ts, deleted_by, name, loc_name, description, is_default_role, role_type, SECURITY_SCOPE) VALUES ('6285efa4-f89c-b94a-de90-ae113c08b2b6', now(), 'admin', 1, now(), NULL, NULL, NULL, 'Tesla role', NULL, NULL, NULL, NULL, 'GENERIC_UI');
...
--MR
INSERT INTO ldap_matching_rule (id, version, create_ts, created_by, update_ts, updated_by, delete_ts, deleted_by, rule_type, matching_rule_status_id, matching_rule_order_id, description, access_group_id, is_terminal_rule, is_override_existing_roles, is_override_exist_access_grp, string_condition, roles_list) VALUES ('5eec7833-151e-40e6-a8c0-b41b71f6e1b2', 7, now(), 'admin', now(), 'admin', NULL, NULL, 'SCRIPTING', '08968d29-ca43-2cf4-e046-fd3b1081f263', '1f0cb7c8-532a-958d-482f-42c32a9f1408', 'Assign roles according to user CN and SN attribute', '0fa2b1a5-1d68-4d69-9fbd-dff348347f93', false, false, false, '{ldapContext}.ldapUser.cn=="Carl Friedrich Gauss"  && {ldapContext}.ldapUser.sn == "Gauss"', 'Gauss;Custom Ldap Role');
INSERT INTO ldap_matching_rule (id, version, create_ts, created_by, update_ts, updated_by, delete_ts, deleted_by, rule_type, matching_rule_status_id, matching_rule_order_id, description, access_group_id, is_terminal_rule, is_override_existing_roles, is_override_exist_access_grp, string_condition, roles_list) VALUES ('b5d4effd-f202-2170-e0d7-414760c56f49', 7, now(), 'admin', now(), 'admin', NULL, NULL, 'SIMPLE', '3747f923-c3f0-66d4-96f1-8a11d95a35e5', '4d76fafb-121e-36da-63eb-7c7afd608d5f', 'Assign rules according to MAIL attribute', '0fa2b1a5-1d68-4d69-9fbd-dff348347f93', false, false, false, NULL, 'Mathematicians');
